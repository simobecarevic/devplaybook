...
const pLangs = {
    pl1: "",
    pl2: ""/* ,
    pl3: "" */ // optional pl3 if add third window feature
}
...
function matchBoxHeight(cb1, cb2){
    ...
    if (cb1H > cb2H) {
        let diff = cb1H-cb2H;
        cb2.setAttribute("style", `margin: 0 0 ${diff}px 0`);
        cb1.setAttribute("style", `margin: 0 0 0 0`);
    }
    if (cb2H > cb1H) {
        let diff = cb2H - cb1H;
        console.log(cb1.style.margin);
        cb1.setAttribute("style", `margin: 0 0 ${diff}px 0`);
        cb2.setAttribute("style", `margin: 0 0 0 0`);
        console.log(cb1.style.margin);
    }
    else if (cb1H == cb2H) {
        // codeBoxes are same height, get rid of margin on both;
        cb2.setAttribute("style", `margin: 0 0 0 0`);
        cb1.setAttribute("style", `margin: 0 0 0 0`);
    }
}
